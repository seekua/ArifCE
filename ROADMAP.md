...
- **Remaining evaluator calibration:** Phases 69–74 close seven of ten replacements with finite calibration: secret boundary, acceptance policy, cross-process storage/index reconstruction, repository freshness, acceptance/handoff propagation, deterministic graph and change contracts. Flight recorder, MCP validation, unfinished-verification policy and fresh real A/B runs remain open. Existing finite limitations still apply; the contract fixture does not establish authentic human/reviewer identity, atomic mid-write recovery, simultaneous writers or complete semantic impact. These controls do not establish model effectiveness.
- **Evaluator coverage remediation (FINDING-0005):** public contracts and TRX scoring are verified; seven evaluators are strengthened/calibrated. Product-effectiveness claims remain disabled while flight recorder, MCP validation and unfinished-verification policy remain. Next strengthen structured run capture, failure promotion, redaction, transition and size-bound assertions with good/bad controls. See docs/evidence/benchmark-contract-calibration-2026-09-03.md. Exposing compatibility requirements does not make partial assertions complete.
