...
- [ ] Phase 79: bind the external model study to a balanced, reproducible execution order before any metered run, then execute and publish all 20 matched pairs without favorable-result filtering.
