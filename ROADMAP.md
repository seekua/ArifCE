...
- [ ] Phase 75: replace the flight-recorder existence test with three pinned security, lifecycle, failed-attempt and finite-growth evaluators. Local verification passes 108 tests, independent completion, secret-scan controls and good/six-mutant calibration; FINDING-0009 and FINDING-0010 are resolved locally. Remote publication and CI evidence are still required before closure. See docs/evidence/benchmark-flight-recorder-calibration-2026-09-07.md.

## Explicit deferrals

- **Remaining evaluator calibration:** Phases 69–74 close seven of ten replacements remotely; Phase 75 is locally complete and awaits publication/CI. Secret boundary, acceptance policy, cross-process storage/index reconstruction, repository freshness, acceptance/handoff propagation, deterministic graph, change contracts and flight recorder now have finite calibration. MCP validation, unfinished-verification policy and fresh real A/B runs remain open. Existing finite limitations still apply; these controls do not establish model effectiveness.
- **Evaluator coverage remediation (FINDING-0005):** public contracts and TRX scoring are verified; eight evaluators are strengthened/calibrated locally, with the eighth awaiting remote CI evidence. Product-effectiveness claims remain disabled while MCP validation and unfinished-verification policy remain. Next close Phase 75 remotely, then strengthen MCP validation against canonical side effects, traversal, duplicate/oversized and malformed requests. See docs/evidence/benchmark-flight-recorder-calibration-2026-09-07.md. Exposing compatibility requirements does not make partial assertions complete.
