function ConvertTo-BenchmarkFlightRecorderSource([string]$Source) {
    ...
    return $Source.Replace('namespace ArifCE.Tests;', 'namespace ArifCE.IndependentEvaluator;').Replace('public sealed class BenchmarkFlightRecorderTests', 'public sealed class IndependentTests').Replace('public BenchmarkFlightRecorderTests()', 'public IndependentTests()')
}
