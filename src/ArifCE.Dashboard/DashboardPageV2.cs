...
{
public const string DailyBriefScript = "<script src=\"/assets/dashboard-daily-brief.js\"></script>";
    public const string ActivityTimelineScript = "<script src=\"/assets/dashboard-activity-timeline.js\"></script>";
    public const string ProviderScript = "<script src=\"/assets/dashboard-provider-health.js\"></script>";
    public const string ExecutiveSummaryScript = "<script src=\"/assets/dashboard-executive-summary.js\"></script>";
    public const string LlmScript = "<script src=\"/assets/dashboard-llm-activity.js\"></script>";
    public const string DecisionBriefScript = "<script src=\"/assets/dashboard-decision-brief.js\"></script>";
    public const string ExtraScript = "<script src=\"/assets/dashboard-claims-evidence.js\"></script>";
    public const string WorkScript = "<script src=\"/assets/dashboard-work-board.js\"></script>";
    public const string HandoffScript = "<script src=\"/assets/dashboard-handoff.js\"></script>";
    public const string ExplorerScript = "<script src=\"/assets/dashboard-memory-explorer.js\"></script>";
    public const string WorkspaceScript = "<script src=\"/assets/dashboard-workspace.js\"></script>";
