...
:root{--arif-blue:#2f80ed;--arif-ink:#182433}body{background:#f4f7fb;color:var(--arif-ink)}.navbar-brand{font-weight:700;letter-spacing:-.02em}.brand-mark{color:var(--arif-blue);font-size:1.35rem}.hero{background:linear-gradient(120deg,#14213d,#2057a6);color:#fff;border:0}.hero .text-secondary{color:#d7e6ff!important}.sidebar-link{border-radius:6px;margin:.15rem 0}.sidebar-link.active{background:#e8f1ff;color:#1769d0;font-weight:600}.card-title{font-weight:650}pre{white-space:pre-wrap;color:#536273;background:#f8fafc;border-radius:6px;padding:1rem;max-height:320px;overflow:auto}.metric{font-size:1.65rem;font-weight:700}.feature-icon{color:var(--arif-blue)}.section-label{font-size:.75rem;letter-spacing:.08em;text-transform:uppercase;color:#718096;font-weight:700}
</style></head>
<body><header class="navbar navbar-expand-md d-print-none"><div class="container-xl"><a class="navbar-brand" href="#overview"><span class="brand-mark">Arif</span>CE <span class="text-secondary fw-normal">dashboard</span></a><div class="navbar-nav flex-row order-md-last"><a class="nav-link" href="https://github.com/seekua/ArifCE" target="_blank">GitHub ↗</a></div></div></header>
