...
app.MapGet("/", () => Results.Content(DashboardPage.Html.Replace("/main/", "/master/").Replace("</body>", "<script>document.querySelector('#sidebarToggle')?.addEventListener('click',()=>document.body.classList.toggle('sidebar-collapsed'));</script></body>"), "text/html; charset=utf-8"));
...
:root{--arif-blue:#2f80ed;--arif-ink:#182433}body{background:#f4f7fb;color:var(--arif-ink)}.navbar-brand{font-weight:700;letter-spacing:-.02em}.brand-logo{height:34px;width:auto;display:block}.hero{background:linear-gradient(120deg,#14213d,#2057a6);color:#fff;border:0}.hero .text-secondary{color:#d7e6ff!important}.sidebar-link{border-radius:6px;margin:.15rem 0}.sidebar-link.active{background:#e8f1ff;color:#1769d0;font-weight:600}.card-title{font-weight:650}pre{white-space:pre-wrap;color:#536273;background:#f8fafc;border-radius:6px;padding:1rem;max-height:320px;overflow:auto}.metric{font-size:1.65rem;font-weight:700}.feature-icon{color:var(--arif-blue)}.section-label{font-size:.75rem;letter-spacing:.08em;text-transform:uppercase;color:#718096;font-weight:700}.sidebar-collapsed .navbar-vertical{width:4.5rem}.sidebar-collapsed .navbar-vertical .nav-link{font-size:0;justify-content:center}.sidebar-collapsed .navbar-vertical .nav-link:before{content:'•';font-size:1.2rem}.sidebar-collapsed .navbar-vertical .section-label{display:none}.sidebar-collapsed .page-wrapper{margin-left:4.5rem}
</style></head>
