...
internal static class Cli
{
    ...
    private static void Help() => Console.WriteLine("ArifCE 0.1\n\nCommands: init, adopt, status, doctor, rebuild, search, context, checkpoint, handoff, task create|status|complete, claim create|status, verify, why, refactor start|status|checkpoint|resolve|verify|finish|abandon");
}
