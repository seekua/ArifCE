...
The fix at `28ea327` passed the full 92-test local suite and the extended Windows controls. [CI run 33737427375](https://github.com/seekua/ArifCE/actions/runs/33737427375) at `c7dbdef` then passed 92/92 on all three OS targets, all five binaries and the extended storage controls on Ubuntu. FINDING-0007 is resolved in Phase 71; the two earlier failing CI runs remain part of the evidence, not discarded outliers.
