...
V0.2.0 একটি ক্রস-প্ল্যাটফর্ম .NET গ্লোবাল টুল হিসেবে প্রকাশিত। [ইনস্টলেশন](../getting-started/installation.md) ও [দ্রুত শুরু](../getting-started/quick-start.md) দেখুন। সোর্স থেকে:
