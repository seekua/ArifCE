...
V0.2.0 platformlar arası bir .NET global aracı olarak yayımlandı. [Kurulum](../getting-started/installation.md) ve [hızlı başlangıç](../getting-started/quick-start.md) belgelerine bakın. Kaynak koddan:
