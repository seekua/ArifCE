...
Перед использованием любого примера установите и запустите Ollama. Первая команда загружает модель `llama3`; оставьте Ollama работающим на указанном ниже локальном endpoint.
