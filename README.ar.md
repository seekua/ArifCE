...
**يتغير الوكلاء، لكن المشروع لا ينسى.** ArifCE هو طبقة محلية أولاً تركز على ذكاء المشاريع واستمراريتها، مخصصة لتطوير البرمجيات بمساعدة الذكاء الاصطناعي. وهي تحتفظ بالسياق، والقرارات، والمحاولات الفاشلة، والأدلة، وحالة إعادة الهيكلة، ومعلومات التسليم مع المستودع، بحيث يمكن لـ Codex وClaude Code وOpenCode والوكلاء المستقبليين مواصلة نفس مسار العمل الهندسي.
...
يتبع المقدمة المترجمة أعلاه مرجع المنتج الأساسي الكامل. يحافظ ذلك على توفر كل أمر ورابط وشارة وملاحظة أمان وقيد أثناء استكمال الترجمة البشرية الكاملة.

**يتغير الوكلاء، لكن مشروعك يجب ألا ينسى.**
